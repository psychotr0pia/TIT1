                                            ...
                                            <div key={index.id} className="relative flex justify-end items-center gap-2">
                                                ...
                                                >
                                                    ...
                                                    <DropdownMenu>
                                                        ...
                                                        >
                                                            <RouterLink to={`/camaras/camara/${index.id}`} key={index.id} className='w-full bg-red-100'>
                                                        ...
                                                        <DropdownItem
                                                            className='bg-gray-500 hover:bg-gray-400 rounded-lg transition-all duration-150'
                                                        >
                                                            <RouterLink to={"/camaras/historialCamara/" + index.id} className='w-full bg-red-100'>
